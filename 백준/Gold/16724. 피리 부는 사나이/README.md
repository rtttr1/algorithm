...
### 풀이
밖으로 나가는 방향이 없기 때문에 사이클이 몇개인지 찾으면 되는 문제였다.
DFS, 분리집합을 떠올렸고 DFS를 사용해서 풀어주었다.
이미 존재하는 사이클에 도달하는 경우를 신경써주면 쉽게 풀 수 있던 문제였다.
