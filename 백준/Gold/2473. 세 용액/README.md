...
### 풀이
처음에 백트래킹으로 3개의 용액을 뽑는 조합을 구해 풀려고 했다. 시간초과가 나서 풀 수 없었다.
따라서 기존에 두 용액을 푼 방법인 투포인터를 통해서 접근을 하여 왼쪽 포인터를 고정하고, 중앙, 오른쪽 포인터를 움직이는 방식으로 풀 수 있었다.
